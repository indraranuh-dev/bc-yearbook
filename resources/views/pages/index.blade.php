...
<body data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
    ...
    <section class="navbar navbar-fixed-top custom-navbar" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand"><span class="bold">Blaster</span></a>
            </div>
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="nav-item"><a href="#home" class="smoothScroll">HOME</a></li>
                    <li class="nav-item"><a href="#about" class="smoothScroll">ABOUT</a></li>
                    <li class="nav-item"><a href="#portfolio" class="smoothScroll">PORTFOLIO</a></li>
                    <li class="nav-item"><a href="#team" class="smoothScroll">TEAM</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <h3>Planning</h3>
                    <p>Blaster is free responsive layout from <a rel="nofollow" href="http://www.templatemo.com"
                            target="_parent">templatemo</a>. Credit goes to <a rel="nofollow" href="https://pixabay.com"
                            target="_parent">Pixabay</a> for images. You can change icons by looking at <a
                            rel="nofollow" href="https://fortawesome.github.io/Font-Awesome/icons/"
                            target="_parent">FontAwesome icons</a>. Thank you for visiting our website.</p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="0.9s">
                    <i class="fa fa-laptop"></i>
                    <h3>Developing</h3>
                    <p>Example: <a href="#about">&lt;i class=&quot;fa fa-phone&quot;&gt;&lt;/i&gt;</a> for phone icon.
                        <a href="#about">&lt;i class=&quot;fa fa-mobile&quot;&gt;&lt;/i&gt;</a> for mobile icon. Duis
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInUp" data-wow-delay="1s">
                    ...
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                        pariatur. Excepteu sunt in culpa qui officia deserunt mollit anim id.</p>
                </div>
                <hr>
                ...
                <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt
                        ut laoreet. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p>
                    <span><i class="fa fa-mobile"></i> Mobile Apps</span>
                    <div class="progress">
                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="80"
                            aria-valuemin="0" aria-valuemax="100" style="width: 80%;"></div>
                    </div>
                    <span><i class="fa fa-link"></i> Web Development</span>
                    <div class="progress">
                        <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="90"
                            aria-valuemin="0" aria-valuemax="100" style="width: 90%;"></div>
                    </div>
                    <span><i class="fa fa-cloud"></i> Cloud Computing</span>
                    <div class="progress">
                        ...
                        <div class="iso-box-section wow fadeIn" data-wow-delay="0.9s">
                            <div class="iso-box-wrapper col4-iso-box">
                                ...
                                <div class="iso-box photoshop mobile col-lg-4 col-md-4 col-sm-12 col-xs-6">
                                    <a href="images/portfolio-img7.jpg" data-lightbox-gallery="portfolio-gallery"><img
                                            src="images/portfolio-img7.jpg" alt="portfolio img"></a>
                                </div>

                                <div class="iso-box photoshop mobile col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                    <a href="images/portfolio-img8.jpg" data-lightbox-gallery="portfolio-gallery"><img
                                            src="images/portfolio-img8.jpg" alt="portfolio img"></a>
                                </div>

                                <div class="iso-box wordpress mobile col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <a href="images/portfolio-img9.jpg" data-lightbox-gallery="portfolio-gallery"><img
                                            src="images/portfolio-img9.jpg" alt="portfolio img"></a>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <h2 class="subheading">CREATIVE TALENTS FROM WEST COAST</h2>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <form action="#" method="post">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <textarea name="message" rows="7" class="form-control" id="message"
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <ul class="social-icon">
                        <li><a href="http://www.facebook.com/templatemo" class="fa fa-facebook wow bounceIn"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-9">
                    <p>Copyright © 2084 Blaster Studio | Design: <a rel="nofollow" href="http://www.templatemo.com"
    ...
    <script src="{{asset('js/libs/isotope.js')}}"></script>
    <script src="{{asset('js/libs/imagesloaded.js')}}"></script>
    <script src="{{asset('js/libs/nivo-lightbox.js')}}"></script>
